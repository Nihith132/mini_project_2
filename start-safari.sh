...
# Travel Itinerary Planner Startup Script (Safari)
# This script starts both servers and opens in Safari

echo "🚀 Starting Travel Itinerary Planner (Safari)..."
echo ""
...
echo ""
echo "💡 Opening in Safari in 2 seconds..."
sleep 2

# Open in Safari
open -a "Safari" http://localhost:8000/travel.html
