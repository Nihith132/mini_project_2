...
# Travel Itinerary Planner Startup Script (Chrome)
# This script starts both servers and opens in Google Chrome

echo "🚀 Starting Travel Itinerary Planner (Chrome)..."
echo ""
...
echo ""
echo "💡 Opening in Google Chrome in 2 seconds..."
sleep 2

# Open in Google Chrome
open -a "Google Chrome" http://localhost:8000/travel.html
